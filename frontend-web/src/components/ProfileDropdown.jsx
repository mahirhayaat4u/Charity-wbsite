...
const ProfileDropdown = () => {
  ...
  return (
    <button onClick={toggleDropDown} className="text-white md:w-[10rem] z-40 mr-14 md:top-[0.7rem] top-[0.5rem] flex flex-col absolute right-0 py-5 px-5 w-[30%]  bg-cyan-950">
