...
const Donation = () => {
  ...
  return (
    <div className=" h-[100vh] shadow-md p-4 rounded-lg md:p-6 lg:p-8 ">
        <h2 className="text-lg text-white font-bold mb-4 md:text-center md:mb-10 md:mt-10   md:text-xl lg:text-2xl">
          Donation Update
        </h2>
        <div className="  overflow-x-auto md:overflow-visible">
          <table className="bg-white table-auto w-full md:w-3/4 lg:w-2/3 mx-auto">
            <thead>
